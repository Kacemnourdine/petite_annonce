 ...
 */
final class Version20201228182211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD parent_id INT DEFAULT NULL, DROP annonces_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD annonces_id INT NOT NULL, DROP parent_id');
